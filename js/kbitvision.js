...
function set_pra(val, val1)
{
    ...
    function eng_guild_report(val,sfn,sfv)
{
    //alert(val);s
    //alert(sfn);
    //alert(sfv);
...
function eng_guild_submit()
{
    ...
    //alert(sfn);
    //alert(sfv);
    eng_guild_report(1,""+sfn+"",""+sfv+"");
}




function ss_life_time_member_report(val,sfn,sfv)
{
    //alert(val);s
    //alert(sfn);
    //alert(sfv);
    $.ajax({
    type: "POST",
    url: "sumer-school-life-member-ajax.php",   
    async: true,
    data:"page="+val+"&sfn="+sfn+"&sfv="+sfv,
    success: function(result)
    {  
...
function ss_life_time_member_submit()
{
    if(document.getElementById("txt_search").value.trim() =="")
    {
            alert('Enter Search Value');
    ...
    //alert(sfn);
    //alert(sfv);
    ss_life_time_member_report(1,""+sfn+"",""+sfv+"");
}



function ss_simple_member_report(val,sfn,sfv)
{
    //alert(val);s
    //alert(sfn);
    //alert(sfv);
    $.ajax({
    type: "POST",
    url: "sumer-school-simple-member-ajax.php",   
    async: true,
    data:"page="+val+"&sfn="+sfn+"&sfv="+sfv,
    success: function(result)
    {  
...
function ss_simple_member_submit()
{
    if(document.getElementById("txt_search").value.trim() =="")
    {
            alert('Enter Search Value');
    ...
    //alert(sfn);
    //alert(sfv);
    ss_simple_member_report(1,""+sfn+"",""+sfv+"");
}
...
function simple_haridwar_member_report(val,sfn,sfv)
{
    //alert(val);s
    //alert(sfn);
    //alert(sfv);
    $.ajax({
    type: "POST",
    url: "simple-haridwar-member_ajax.php",   
    async: true,
    data:"page="+val+"&sfn="+sfn+"&sfv="+sfv,
    success: function(result)
    {  
...
function simple_haridwar_member_submit()
{
    if(document.getElementById("txt_search").value.trim() =="")
    {
            alert('Enter Search Value');
    ...
    //alert(sfn);
    //alert(sfv);
    simple_haridwar_member_report(1,""+sfn+"",""+sfv+"");
}




function life_time_haridwar_member_report(val,sfn,sfv)
{
    //alert(val);
    //alert(sfn);
    //alert(sfv);
    $.ajax({
    type: "POST",
    url: "life-time-haridwar-member_ajax.php",   
    async: true,
    data:"page="+val+"&sfn="+sfn+"&sfv="+sfv,
    success: function(result)
    {  
...
function life_time_haridwar_member_submit()
{
    if(document.getElementById("txt_search").value.trim() =="")
    {
            alert('Enter Search Value');
    ...
    //alert(sfn);
    //alert(sfv);
    life_time_haridwar_member_report(1,""+sfn+"",""+sfv+"");
}



function other_member_report(val,sfn,sfv)
{
    //alert(val);
    //alert(sfn);
    //alert(sfv);
...
function unemp_report(val,sfn,sfv)
{
    //alert(val);
    //alert(sfn);
    //alert(sfv);
...
function unemp_submit()
{
    ...
    //alert(sfn);
    //alert(sfv);
    unemp_report(1,""+sfn+"",""+sfv+"");
}



function othestud_report(val,sfn,sfv)
{
    //alert(val);
    //alert(sfn);
    //alert(sfv);
...
function othestud_submit()
{
    ...
    //alert(sfn);
    //alert(sfv);
    othestud_report(1,""+sfn+"",""+sfv+"");
}


function othergovt_report(val,sfn,sfv)
{
    //alert(val);
    //alert(sfn);
    //alert(sfv);
...
function othergovt_submit()
{
    ...
    //alert(sfn);
    //alert(sfv);
    othergovt_report(1,""+sfn+"",""+sfv+"");
}



function privemp_report(val,sfn,sfv)
{
    //alert(val);
    //alert(sfn);
    //alert(sfv);
